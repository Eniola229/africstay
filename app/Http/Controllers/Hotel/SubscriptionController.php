 ...
 *  - later for renewals/upgrades (when a subscription is past_due/expired or user wants to change tier).
 */
class SubscriptionController extends Controller
{
    ...
    public function showPlans()
    {
        ...
        return view('hotel.subscription.plans', [
            'hotel' => $hotel,
            'tiers' => $this->tierData(),
            'currentTier' => $hotel->tier, // Which plan they're currently on (null if no active subscription)
            'subscriptionStatus' => $hotel->subscription_status, // 'active', 'pending_payment', 'expired', null
            'subscriptionEndsAt' => $hotel->subscription_ends_at,
        ]);
    }
