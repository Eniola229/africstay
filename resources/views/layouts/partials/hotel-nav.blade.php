    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            <ul class="nxl-navbar">
                ...
                <li class="nxl-item nxl-hasmenu {{ request()->routeIs('hotel.wallet*') ? 'active' : '' }}">
                    <a href="javascript:void(0);" class="nxl-link">
                    ...
                    <ul class="nxl-submenu">
                        <li class="nxl-item"><a class="nxl-link" href="{{ route('hotel.wallet.index') }}">Wallet</a></li>
                        @if($role === 'owner')
                        <li class="nxl-item"><a class="nxl-link" href="{{ route('hotel.wallet.withdrawals') }}">Withdrawals</a></li>
                        @endif
                    </ul>
                </li>
                @endif
