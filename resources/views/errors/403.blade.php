...
<head>
    ...
    <title>403 — Forbidden | AfricStay</title>
...
<body>
    <div class="wrapper">
        ...
        <p class="err-sub">
            ...
            @else
                You don't have permission to view this page. Please contact your hotel manager if you believe this is a mistake.
            @endif
        </p>
        <div class="err-actions">
            <a href="{{ url('/dashboard') }}" class="btn-home">← Dashboard</a>
